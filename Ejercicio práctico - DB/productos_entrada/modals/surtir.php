    ...
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h2 class="my_title">Surtir Producto</h2>
                ...
                <form action="index.php" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input class="form-control form-control-sm bg-light my_input" type="number" name="cantidad" required onchange="F_validateNum(this)">
                        </div>
                    </div>
                    <br>
...
<script>
    function F_validateNum(tag) {
        const min = tag.getAttribute('min');
        const value = tag.value;
        if (value <= min-1) {
            Swal.fire({icon:"error",title:"Cantidad no permitida",text: "No se permite colocar una cantidad menor a la existente"});
            tag.value = min;
        }
    }
    function F_fillForm(btn){
        ...
        $('input[name="cantidad"]').prop('min', json['cantidad']);
